...
This directory contains the curated PNG and PDF figures used in the revised
main manuscript. Intermediate, superseded, and supplementary figures remain
ignored by Git even if they are present locally.

| Figure | File stem |
|---|---|
| 1 | `fig1_thermal_regime_transition` |
